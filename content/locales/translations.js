...
export const TRANSLATIONS = {
  ru: {
    ...
    price: "Цена пасса (в USDT)",
      ...
      subscribers_metric: "Клиенты",
      active_customers_metric: "Покупатели",
      ...
      validation_offer_desc_min: "Описание должно быть не менее 20 символов!",
      validation_offer_contact_min: "Контакт должен быть не менее 3-х символов!",
      hide: "Скрыть",
      show: "Показать",
      ...
      error_badge: "Ошибка",
      paywall_limit_stores: "Достигнут лимит\nмагазинов (2)",
      paywall_limit_staff: "Достигнут лимит\nсотрудников (3)",
      ...
      paywall_btn_staff: "👥 Анлим сотрудников для этой точки",
      paywall_btn_combo: "💎 КОМБО! Любое количество\nмагазинов и сотрудников",
  ...
  en: {
    ...
    price: "Pass price (in USDT)",
      ...
      subscribers_metric: "Clients",
      active_customers_metric: "Buyers",
      ...
      validation_offer_desc_min: "Description must be at least 20 characters!",
      validation_offer_contact_min: "Contact must be at least 3 characters!",
      hide: "Hide",
      show: "Show",
      ...
      error_badge: "Error",
      paywall_limit_stores: "Store limit\nreached (2)",
      paywall_limit_staff: "Staff limit\nreached (3)",
      ...
      paywall_btn_staff: "👥 Unlimited Staff for this store",
      paywall_btn_combo: "💎 COMBO! Any number of\nstores and staff",
  ...
  es: {
    ...
    price: "Precio del pase (en USDT)",
      ...
      subscribers_metric: "Clientes",
      active_customers_metric: "Compradores",
      ...
      wallet_required_to_create: "Por favor, vincula una billetera Tonkeeper (descarga: https://tonkeeper.com/) antes de crear una oferta. 🚀\n\n¡Es necesaria para que los compradores puedan enviar pagos de pases directamente a tu saldo en USDT en la red TON! También ten en cuenta que para cualquier transacción en la blockchain, debes tener una cantidad muy pequeña de criptomoneda TON (aproximadamente desde 0.05 TON) para pagar la tarifa de red (gas). 😉",
      wallet_required_to_buy: "Por favor, vincula una billetera Tonkeeper (descarga: https://tonkeeper.com/) para comprar un pase. 🚀\n\nTambién ten en cuenta que el saldo de tu billetera debe tener no solo la cantidad necesaria de USDT en la red TON para pagar el pase, sino también una pequeña cantidad de la criptomoneda TON (aproximadamente desde 0.05 TON) para pagar la bajísima tarifa de red (gas). ¡0.05 TON te alcanzarán para pagar cientos de transacciones! 😉",
      wallet_required_to_activate: "Por favor, vincula una billetera Tonkeeper (descarga: https://tonkeeper.com/) para activar esta oferta. 🚀\n\n¡Es necesaria para que los compradores puedan enviar pagos de pases directamente a tu saldo en USDT en la red TON! También ten en cuenta que para cualquier transacción en la blockchain, debes tener una cantidad muy pequeña de criptomoneda TON (aproximadamente desde 0.05 TON) para pagar la tarifa de red (gas). 😉",
      ...
      error_badge: "Error",
      paywall_limit_stores: "Límite de tiendas\nalcanzado (2)",
      paywall_limit_staff: "Límite de empleados\nalcanzado (3)",
      ...
      paywall_btn_staff: "👥 Empleados ilimitados para esta tienda",
      paywall_btn_combo: "💎 ¡COMBO! Cualquier número de\ntiendas y empleados",
  ...
  pt: {
    ...
    price: "Preço do passe (em USDT)",
      ...
      wallet_required_to_create: "Por favor, vincule uma carteira Tonkeeper (baixe aqui: https://tonkeeper.com/) antes de criar uma oferta. 🚀\n\nEla é necessária para que os compradores possam enviar pagamentos de passes diretamente para o seu saldo em USDT na rede TON! Além disso, observe que para qualquer transação na blockchain, você precisa ter uma quantia muito pequena da criptomoeda TON (cerca de 0.05 TON) para pagar a taxa de rede (gás). 😉",
      wallet_required_to_buy: "Por favor, vincule uma carteira Tonkeeper (baixe aqui: https://tonkeeper.com/) para comprar um passe. 🚀\n\nAlém disso, observe que o saldo da sua carteira deve conter não apenas a quantidade necessária de USDT na rede TON para pagar o passe, mas também uma pequena quantidade da criptomoeda TON (cerca de 0.05 TON) para pagar a taxa de rede super barata (gás). 0.05 TON são suficientes para pagar centenas de transações! 😉",
      wallet_required_to_activate: "Por favor, vincule uma carteira Tonkeeper (baixe aqui: https://tonkeeper.com/) para ativar esta oferta. 🚀\n\nEla é necessária para que os compradores possam enviar pagamentos de passes diretamente para o seu saldo em USDT na rede TON! Além disso, observe que para qualquer transação na blockchain, você precisa ter uma quantia muito pequena da criptomoeda TON (cerca de 0.05 TON) para pagar a taxa de rede (gás). 😉",
      ...
      error_badge: "Erro",
      paywall_limit_stores: "Limite de lojas\natingido (2)",
      paywall_limit_staff: "Limite de funcionários\natingido (3)",
      ...
      paywall_btn_staff: "👥 Funcionários ilimitados para esta loja",
      paywall_btn_combo: "💎 COMBO! Qualquer quantidade de\nlojas e funcionários",
  ...
  id: {
    ...
    price: "Harga pass (dalam USDT)",
      ...
      subscribers_metric: "Pelanggan",
      active_customers_metric: "Pembeli",
      ...
      wallet_required_to_create: "Silakan hubungkan dompet Tonkeeper (unduh: https://tonkeeper.com/) sebelum membuat penawaran. 🚀\n\nIni diperlukan agar pembeli dapat mengirim pembayaran pass langsung ke saldo USDT Anda di jaringan TON! Harap dicatat juga bahwa untuk melakukan transaksi apa pun di blockchain, saldo dompet Anda harus memiliki sejumlah kecil mata uang kripto TON (mulai sekitar 0.05 TON) untuk membayar biaya jaringan (gas). 😉",
      wallet_required_to_buy: "Silakan hubungkan dompet Tonkeeper (unduh: https://tonkeeper.com/) untuk membeli pass. 🚀\n\nHarap dicatat juga bahwa saldo dompet Anda tidak hanya harus memiliki jumlah USDT yang diperlukan di jaringan TON untuk membayar pass, tetapi juga sejumlah kecil mata uang kripto TON (mulai sekitar 0.05 TON) untuk membayar biaya jaringan (gas) yang sangat murah. 0.05 TON sudah cukup untuk membayar ratusan transaksi! 😉",
      wallet_required_to_activate: "Silakan hubungkan dompet Tonkeeper (unduh: https://tonkeeper.com/) untuk mengaktifkan penawaran ini. 🚀\n\nIni diperlukan agar pembeli dapat mengirim pembayaran pass langsung ke saldo USDT Anda di jaringan TON! Harap dicatat juga bahwa untuk melakukan transaksi apa pun di blockchain, saldo dompet Anda harus memiliki sejumlah kecil mata uang kripto TON (mulai sekitar 0.05 TON) untuk membayar biaya jaringan (gas). 😉",
      ...
      error_badge: "Gagal",
      paywall_limit_stores: "Batas toko\ntercapai (2)",
      paywall_limit_staff: "Batas staf\ntercapai (3)",
      ...
      paywall_btn_staff: "👥 Staf Tanpa Batas untuk toko ini",
      paywall_btn_combo: "💎 KOMBO! Berapa pun jumlah\ntoko dan staf",
  ...
  uk: {
    ...
    price: "Ціна пасу (в USDT)",
      ...
      subscribers_metric: "Клієнти",
      active_customers_metric: "Покупці",
      sold_count_small: "продано: {count}",
      ...
      wallet_required_to_create: "Перед створенням пропозиції прив'яжіть гаманець Tonkeeper (скачати: https://tonkeeper.com/). 🚀\n\nВін необхідний, щоб покупці могли надсилати оплату за паси прямо на ваш баланс в USDT у мережі TON! А також врахуйте, що для здійснення будь-яких блокчейн-операцій на балансі гаманця має бути зовсім трохи криптовалюти TON (приблизно від 0.05 TON) — це потрібно для оплати копійчаної мережевої комісії (газу). 😉",
      wallet_required_to_buy: "Для купівлі пасу прив'яжіть гаманець Tonkeeper (скачати: https://tonkeeper.com/). 🚀\n\nА також врахуйте, що на балансі гаманця має бути не тільки необхідна сума в USDT у мережі TON для оплати пасу, але й невелика сума в криптовалюті TON (приблизно від 0.05 TON) — це потрібно для оплати копійчаної мережевої комісії (газу). 0.05 TON вам вистачить для оплати сотень транзакцій! 😉",
      wallet_required_to_activate: "Для активації пропозиції прив'яжіть гаманець Tonkeeper (скачати: https://tonkeeper.com/). 🚀\n\nВін необхідний, щоб покупці могли надсилати оплату за паси прямо на ваш баланс в USDT у мережі TON! А також врахуйте, що для здійснення будь-яких блокчейн-операцій на балансі гаманця має бути зовсім трохи криптовалюти TON (приблизно від 0.05 TON) — це потрібно для оплати копійчаної мережевої комісії (газу). 😉",
      ...
      error_badge: "Помилка",
      paywall_limit_stores: "Досягнуто ліміту\nмагазинів (2)",
      paywall_limit_staff: "Досягнуто ліміту\nспівробітників (3)",
      ...
      paywall_btn_staff: "👥 Анлім співробітників для цієї точки",
      paywall_btn_combo: "💎 КОМБО! Будь-яка кількість\nмагазинів та співробітників",
