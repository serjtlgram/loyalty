...
export const TRANSLATIONS = {
  ru: {
    ...
    wallet_required_to_create: "Перед созданием предложения привяжите кошелёк Tonkeeper https://tonkeeper.com 🚀\n\nОн необходим, чтобы покупатели могли отправлять оплату за пассы прямо на ваш баланс в USDT в сети TON! А также учтите, что для совершения любых блокчейн-операций на балансе кошелька должно быть совсем немного криптовалюты TON (около 1 TON) — это нужно для оплаты копеечной сетевой комиссии (газа). 😉",
    wallet_required_to_buy: "Для покупки пасса привяжите кошелёк Tonkeeper https://tonkeeper.com 🚀\n\nА также учтите, что на балансе кошелька должна быть не только необходимая сумма в USDT в сети TON для оплаты пасса, но и небольшая сумма в криптовалюте TON (около 1 TON) — это нужно для оплаты копеечной сетевой комиссии (газа). 1 TON вам хватит для оплаты сотен транзакций! 😉",
  ...
  en: {
    ...
    wallet_required_to_create: "Please link a Tonkeeper wallet https://tonkeeper.com before creating an offer. 🚀 It is required so that buyers can send payments for passes directly to your balance in USDT (on TON network). Also note that you need a tiny amount of TON (about 1 TON) in your wallet for blockchain transaction fee (gas). 😉",
    wallet_required_to_buy: "Please link a Tonkeeper wallet https://tonkeeper.com to buy a pass. 🚀 Also note that your wallet balance should have both the USDT (on TON network) for the pass and a tiny amount of TON (about 1 TON) for the network fee (gas). This fee is extremely cheap - 1 TON is enough for hundreds of transactions! 😉",
  ...
  es: {
    ...
    wallet_required_to_create: "Por favor, vincula una billetera Tonkeeper https://tonkeeper.com antes de crear una oferta. 🚀\n\n¡Es necesaria para que los compradores puedan enviar pagos de pases directamente a tu saldo en USDT en la red TON! También ten en cuenta que para cualquier transacción en la blockchain, debes tener una cantidad muy pequeña de criptomoneda TON (aproximadamente 1 TON) para pagar la tarifa de red (gas). 😉",
    wallet_required_to_buy: "Por favor, vincula una billetera Tonkeeper https://tonkeeper.com para comprar un pase. 🚀\n\nTambién ten en cuenta que el saldo de tu billetera debe tener no solo la cantidad necesaria de USDT en la red TON para pagar el pase, sino también una pequeña cantidad de la criptomoneda TON (aproximadamente 1 TON) para pagar la bajísima tarifa de red (gas). ¡1 TON te alcanzarán para pagar cientos de transacciones! 😉",
  ...
  pt: {
    ...
    wallet_required_to_create: "Por favor, vincule uma carteira Tonkeeper https://tonkeeper.com antes de criar uma oferta. 🚀\n\nEla é necessária para que os compradores possam enviar pagamentos de passes diretamente para o seu saldo em USDT na rede TON! Além disso, observe que para qualquer transação na blockchain, você precisa ter uma quantia muito pequena da criptomoeda TON (cerca de 1 TON) para pagar a taxa de rede (gás). 😉",
    wallet_required_to_buy: "Por favor, vincule uma carteira Tonkeeper https://tonkeeper.com para comprar um passe. 🚀\n\nAlém disso, observe que o saldo da sua carteira deve conter não apenas a quantidade necessária de USDT na rede TON para pagar o passe, mas também uma pequena quantidade da criptomoeda TON (cerca de 1 TON) para pagar a taxa de rede super barata (gás). 1 TON são suficientes para pagar centenas de transações! 😉",
  ...
  id: {
    ...
    wallet_required_to_create: "Silakan hubungkan dompet Tonkeeper https://tonkeeper.com sebelum membuat penawaran. 🚀\n\nIni diperlukan agar pembeli dapat mengirim pembayaran pass langsung ke saldo USDT Anda di jaringan TON! Harap dicatat juga bahwa untuk melakukan transaksi apa pun di blockchain, saldo dompet Anda harus memiliki sejumlah kecil mata uang kripto TON (mulai sekitar 1 TON) untuk membayar biaya jaringan (gas). 😉",
    wallet_required_to_buy: "Silakan hubungkan dompet Tonkeeper https://tonkeeper.com untuk membeli pass. 🚀\n\nHarap dicatat juga bahwa saldo dompet Anda tidak hanya harus memiliki jumlah USDT yang diperlukan di jaringan TON untuk membayar pass, tetapi juga sejumlah kecil mata uang kripto TON (mulai sekitar 1 TON) untuk membayar biaya jaringan (gas) yang sangat murah. 1 TON sudah cukup untuk membayar ratusan transaksi! 😉",
  ...
  uk: {
    ...
    wallet_required_to_create: "Перед створенням пропозиції прив'яжіть гаманець Tonkeeper https://tonkeeper.com 🚀\n\nВін необхідний, щоб покупці могли надсилати оплату за паси прямо на ваш баланс в USDT у мережі TON! А також врахуйте, що для здійснення будь-яких блокчейн-операцій на балансі гаманця має бути зовсім трохи криптовалюти TON (приблизно від 1 TON) — це потрібно для оплати копійчаної мережевої комісії (газу). 😉",
    wallet_required_to_buy: "Для купівлі пасу прив'яжіть гаманець Tonkeeper https://tonkeeper.com 🚀\n\nА також врахуйте, що на балансі гаманця має бути не тільки необхідна сума в USDT у мережі TON для оплати пасу, але й невелика сума в криптовалюті TON (приблизно від 1 TON) — це потрібно для оплати копійчаної мережевої комісії (газу). 1 TON вам вистачить для оплати сотень транзакцій! 😉",
