...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    wallet_required_to_create: "Please link a Tonkeeper wallet https://tonkeeper.com before creating an offer. 🚀 It is required so that buyers can send payments for passes directly to your balance in USDT (on TON network). Also note that you need a tiny amount of TON (about 0.05 TON) in your wallet for blockchain transaction fee (gas). 😉",
    wallet_required_to_buy: "Please link a Tonkeeper wallet https://tonkeeper.com to buy a pass. 🚀 Also note that your wallet balance should have both the USDT (on TON network) for the pass and a tiny amount of TON (about 0.05 TON) for the network fee (gas). This fee is extremely cheap - 0.05 TON is enough for hundreds of transactions! 😉",
    wallet_required_to_activate: "Please link a Tonkeeper wallet https://tonkeeper.com to activate this offer. 🚀 It is required so that buyers can send payments for passes directly to your balance in USDT (on TON network). Also note that you need a tiny amount of TON (about 0.05 TON) in your wallet for blockchain transaction fee (gas). 😉",
